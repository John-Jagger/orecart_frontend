...
export default function App() {
  ...
  useEffect(() => {
    if(!hasAlerted.current){
      alert("IMPORTANT UPDATE:\nThe orecart.net beta is now finished. This means this site will no longer be able to track the ore cart for the time being. For more information go to our NEWS button in the bottom left.");
